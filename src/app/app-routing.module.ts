...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'offline',
        loadChildren: () => import('./pages/offline-data/offline-data.module').then(m => m.OfflineDataModule),
        pathMatch: 'full'
      },
      {
        path:'graphs',
        loadChildren:()=>import('./pages/graphs/graphs.module').then(m=>m.GraphsModule),
        pathMatch: 'full'
      },
